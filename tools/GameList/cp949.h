...
WCHAR CP949_ff_convert (	/* Converted code, 0 means conversion error */
...
)
{
	...
	if (src < 0x80) {	/* ASCII */
		...
		if (dir) {		/* OEMCP to unicode */
			p = CP949_oem2uni;
			hi = sizeof(CP949_oem2uni) / 4 - 1;
		} else {		/* Unicode to OEMCP */
			p = CP949_uni2oem;
			hi = sizeof(CP949_uni2oem) / 4 - 1;
		}
		li = 0;
		for (n = 16; n; n--) {
			i = li + (hi - li) / 2;
...
WCHAR CP949_ff_wtoupper (	/* Upper converted character */
