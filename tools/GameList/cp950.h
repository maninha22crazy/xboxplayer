...
WCHAR CP950_ff_convert (	/* Converted code, 0 means conversion error */
...
)
{
	...
	if (src < 0x80) {	/* ASCII */
		...
		if (dir) {		/* OEMCP to unicode */
			p = CP950_oem2uni;
			hi = sizeof(CP950_oem2uni) / 4 - 1;
		} else {		/* Unicode to OEMCP */
			p = CP950_uni2oem;
			hi = sizeof(CP950_uni2oem) / 4 - 1;
		}
		li = 0;
		for (n = 16; n; n--) {
			i = li + (hi - li) / 2;
...
WCHAR CP950_ff_wtoupper (	/* Upper converted character */
