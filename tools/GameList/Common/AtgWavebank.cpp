...
//--------------------------------------------------------------------------------------
DWORD CWavebank::GetEntryCount( void )
{
...
//--------------------------------------------------------------------------------------
HRESULT CWavebank::GetEntryFormat( const DWORD dwEntry, WAVEFORMATEX* pFormat )
{
    ...
    WAVEBANKMINIWAVEFORMAT& miniFmt =
    ...
    pFormat->nBlockAlign = miniFmt.wBlockAlign;
...
//--------------------------------------------------------------------------------------
DWORD CWavebank::GetEntryLengthInBytes( const DWORD dwEntry )
{
    assert( m_pDataEntry != NULL );
...
//--------------------------------------------------------------------------------------
HRESULT CWavebank::GetEntryData( const DWORD dwEntry, void** pSample )
{
    assert( m_pDataEntry != NULL );
    assert( pSample );
    *pSample = NULL;
...
// Desc: Retrieve a pointer of sample data
//--------------------------------------------------------------------------------------
DWORD CWavebank::GetEntryOffset( const DWORD dwEntry )
{
    assert( m_pDataEntry != NULL );
